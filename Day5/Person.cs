...
namespace Day5
{
    internal abstract class Person
    {
        ...
        {
            return $"Social Number : {this.socialNumber}|Fullname : {this.firstName} {this.lastName}|Email : {this.email}|Birthday: {this.birthday} | Total Revenue : {this.TotalRevenue.ToString("C", new CultureInfo("id-ID"))}";
